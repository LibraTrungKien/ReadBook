...
public abstract class Hilt_PostStoryFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PostStoryFragment_GeneratedInjector) this.generatedComponent()).injectPostStoryFragment(UnsafeCasts.<PostStoryFragment>unsafeCast(this));
    }
  }
