...
public abstract class Hilt_StoryFavouriteFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StoryFavouriteFragment_GeneratedInjector) this.generatedComponent()).injectStoryFavouriteFragment(UnsafeCasts.<StoryFavouriteFragment>unsafeCast(this));
    }
  }
