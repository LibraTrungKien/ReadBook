...
public abstract class Hilt_ManagerStoryFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ManagerStoryFragment_GeneratedInjector) this.generatedComponent()).injectManagerStoryFragment(UnsafeCasts.<ManagerStoryFragment>unsafeCast(this));
    }
  }
