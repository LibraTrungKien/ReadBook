...
public abstract class Hilt_PostManagementFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PostManagementFragment_GeneratedInjector) this.generatedComponent()).injectPostManagementFragment(UnsafeCasts.<PostManagementFragment>unsafeCast(this));
    }
  }
