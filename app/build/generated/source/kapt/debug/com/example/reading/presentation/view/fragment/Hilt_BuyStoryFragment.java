...
public abstract class Hilt_BuyStoryFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BuyStoryFragment_GeneratedInjector) this.generatedComponent()).injectBuyStoryFragment(UnsafeCasts.<BuyStoryFragment>unsafeCast(this));
    }
  }
