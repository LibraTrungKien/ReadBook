...
public abstract class Hilt_SearchStoryFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchStoryFragment_GeneratedInjector) this.generatedComponent()).injectSearchStoryFragment(UnsafeCasts.<SearchStoryFragment>unsafeCast(this));
    }
  }
