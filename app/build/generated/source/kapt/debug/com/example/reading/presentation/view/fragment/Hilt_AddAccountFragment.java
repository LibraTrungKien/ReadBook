...
public abstract class Hilt_AddAccountFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddAccountFragment_GeneratedInjector) this.generatedComponent()).injectAddAccountFragment(UnsafeCasts.<AddAccountFragment>unsafeCast(this));
    }
  }
