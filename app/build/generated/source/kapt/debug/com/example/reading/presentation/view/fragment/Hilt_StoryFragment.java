...
public abstract class Hilt_StoryFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StoryFragment_GeneratedInjector) this.generatedComponent()).injectStoryFragment(UnsafeCasts.<StoryFragment>unsafeCast(this));
    }
  }
