...
public abstract class Hilt_ManageAccountFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ManageAccountFragment_GeneratedInjector) this.generatedComponent()).injectManageAccountFragment(UnsafeCasts.<ManageAccountFragment>unsafeCast(this));
    }
  }
