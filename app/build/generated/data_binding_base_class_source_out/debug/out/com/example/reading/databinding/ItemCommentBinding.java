...
public final class ItemCommentBinding implements ViewBinding {
  ...
  private ItemCommentBinding(@NonNull LinearLayout rootView, @NonNull TextView txtContent,
  ...
  public static ItemCommentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCommentBinding((LinearLayout) rootView, txtContent, txtUserName);
    }
